...
##### Load Data
    print('REGENERATING...\n')
    delay=10 #Takens delay

    def load_data(): 
        _data=np.loadtxt('Data/Lorenz_Coarse.txt')[:,0]
        
        data=np.zeros((_data.shape[0]-delay,delay))
        #Construct delay coordinates
        for i in range(delay):
            data[:,i]=_data[i:_data.shape[0]-delay+i]
    ...
    Y_train[:,0]=data[discard+delay:discard+train_len+delay,0]
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/Lorenz/takens_delay_predicted.txt',u_predicted)
    np.savetxt('Predicted_Data/Lorenz/takens_delay_actual.txt',u_data[train_len+discard:train_len+discard+prediction_len])
...
plt.savefig('Img/Lorenz-Coarse/Takens-Traj.png')
plt.show()
####
...
plt.savefig('Img/Lorenz-Coarse/Takens-Recur.png')
plt.show()
####
plt.rcParams['figure.figsize'] = [16,8]
spec = gridspec.GridSpec( nrows=1,ncols=2,
...
plt.savefig('Img/Lorenz-Coarse/Takens-Attractor.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/Takens-Attractor-Overlay.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/Takens-Hist.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/Takens-Autocor.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/Takens-Autocor-Overlay.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/Takens-CDF.png')
plt.show()