...
##### Load Data
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/PM/sindy_predicted.txt',x_test_sim)
    np.savetxt('Predicted_Data/PM/sindy_actual.txt',u_data[S:])
...
plt.savefig('Img/PM/Sindy-Traj.png')
plt.show()
...
plt.savefig('Img/PM/Sindy-Attractor-Overlay.png')
plt.show()
...
plt.savefig('Img/PM/Sindy-Attractor.png')
plt.show()
...
plt.savefig('Img/PM/Sindy-Hist.png')
plt.show()
...
plt.savefig('Img/PM/Sindy-Autocor.png')
plt.show()
...
plt.savefig('Img/PM/Sindy-Autocor-Overlay.png')
plt.show()
...
plt.savefig('Img/PM/Sindy-CDF.png')
plt.show()