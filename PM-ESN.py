...
##### Load Data
   ...
   #############################################
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/PM/esn_delay_predicted.txt',u_predicted)
    np.savetxt('Predicted_Data/PM/esn_delay_actual.txt',data[train_len+discard:train_len+discard+prediction_len])
...
try:
    ...
    axs1.plot(range(50),u_predicted[0:50],lw=0.5,color='darkblue')
    axs2.plot(range(60),[x+1 for x in u_predicted[0:60]],lw=0.5,color='darkblue')
    ...
    plt.savefig('Img/PM/ESN-Traj.png')
    plt.show()
    ...
    plt.savefig('Img/PM/ESN-Attractor-Overlay.png')
    plt.show()
    ...
    plt.savefig('Img/PM/ESN-Attractor.png')
    plt.show()
    ...
    plt.savefig('Img/PM/ESN-Hist.png')
    plt.show()
    ...
    plt.savefig('Img/PM/ESN-Autocor.png')
    plt.show()
    ...
    plt.savefig('Img/PM/ESN-Autocor-Overlay.png')
    plt.show()
    ...
    plt.savefig('Img/PM/ESN-CDF.png')
    plt.show()
except:
