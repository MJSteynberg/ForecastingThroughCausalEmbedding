...
##### Load Data
    ...
    print(nolds.lyap_r(X_train[:,0:dim]))
    for i in range(delay):
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/Henon_Fine/delay_fine_predicted.txt',u_predicted)
    np.savetxt('Predicted_Data/Henon_Fine/delay_fine_actual.txt',u_data[S:])
...
plt.savefig('Img/Henon_Fine/RCN-Traj.png')
plt.show()
# 
...
plt.savefig('Img/Henon_Fine/RCN-Attractor-Overlay.png')
plt.show()
...
plt.savefig('Img/Henon_Fine/RCN-Attractor.png')
plt.show()
...
plt.savefig('Img/Henon_Fine/RCN-Hist.png')
plt.show()
...
plt.savefig('Img/Henon_Fine/RCN-Autocor.png')
plt.show()
...
plt.savefig('Img/Henon_Fine/RCN-Autocor-Overlay.png')
plt.show()
...
plt.savefig('Img/Henon_Fine/RCN-CDF.png')
plt.show()