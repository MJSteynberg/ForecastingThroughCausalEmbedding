...
##### Load Data
    ...
    ax.plot(data[0:1000,0],data[0:1000,1], data[0:1000,2],lw=0.5,color='red')
    ...
    u_predicted=np.zeros((prediction_len,data.shape[1]))
    u_predicted[0]=data[train_len+discard]
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/Henon_Fine/takens_delay_comp_predicted.txt',u_predicted)
    np.savetxt('Predicted_Data/Henon_Fine/takens_delay_comp_actual.txt',data[train_len+discard:train_len+discard+prediction_len])
...
plt.savefig('Img/Henon_Fine/Takens-Traj.png')
plt.show()
# 
...
plt.savefig('Img/Henon_Fine/Takens-Attractor-Overlay.png')
plt.show()
...
plt.savefig('Img/Henon_Fine/Takens-Attractor.png')
plt.show()
...
plt.savefig('Img/Henon_Fine/Takens-Hist.png')
plt.show()
...
plt.savefig('Img/Henon_Fine/Takens-Autocor.png')
plt.show()
...
plt.savefig('Img/Henon_Fine/Takens-Autocor-Overlay.png')
plt.show()
...
plt.savefig('Img/Henon_Fine/Takens-CDF.png')
plt.show()