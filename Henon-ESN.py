...
##### Load Data
   ...
   #############################################
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/Henon/esn_delay_comp_predicted.txt',u_predicted)
    np.savetxt('Predicted_Data/Henon/esn_delay_comp_actual.txt',data[train_len+discard:train_len+discard+prediction_len])
...
try:
    ...
    axs2.plot(range(100),[abs(x)+1 for x in u_predicted[0:100,0]],lw=0.5,color='darkblue')
    ...
    axs1.set(ylim = (-0.28, 0.28))
    plt.savefig('Img/Henon/ESN-Traj.png')
    plt.show()
    # 
    ...
    plt.savefig('Img/Henon/ESN-Attractor-Overlay.png')
    plt.show()
    ...
    plt.savefig('Img/Henon/ESN-Attractor.png')
    plt.show()
    ...
    plt.savefig('Img/Henon/ESN-Hist.png')
    plt.show()
    ...
    plt.savefig('Img/Henon/ESN-Autocor.png')
    plt.show()
    ...
    plt.savefig('Img/Henon/ESN-Autocor-Overlay.png')
    plt.show()
    ...
    plt.savefig('Img/Henon/ESN-CDF.png')
    plt.show()
except:
