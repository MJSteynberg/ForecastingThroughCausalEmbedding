...
##### Load Data
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/DP/rcn_predicted.txt',u_predicted)
    np.savetxt('Predicted_Data/DP/rcn_actual.txt',u_data[S:])
...
plt.savefig('Img/DP/RCN-Traj.png')
plt.show()
### Recur
...
plt.savefig('Img/DP/RCN-Recur.png')
plt.show()
####
#### Recur Overlay
...
plt.savefig('Img/DP/RCN-Recur-Overlay_8.png')
plt.show()
####
#### Recur Overlay
plt.rcParams['figure.figsize'] = [5,5]
...
plt.savefig('Img/DP/RCN-Recur-Overlay_16.png')
plt.show()
####
plt.rcParams['figure.figsize'] = [8,4]
spec = gridspec.GridSpec( nrows=1,ncols=2,
...
plt.savefig('Img/DP/RCN-Attractor.png')
plt.show()
...
plt.savefig('Img/DP/RCN-Attractor-Overlay.png')
plt.show()
...
plt.savefig('Img/DP/RCN-Attractor-Overlay-Labels.png')
plt.show()
...
plt.savefig('Img/DP/RCN-Hist.png')
plt.show()
## Autocorrelation
...
plt.savefig('Img/DP/RCN-Autocor.png')
plt.show()
...
plt.savefig('Img/DP/RCN-Autocor-Overlay.png')
plt.show()
...
plt.savefig('Img/DP/RCN-CDF.png')
plt.show()