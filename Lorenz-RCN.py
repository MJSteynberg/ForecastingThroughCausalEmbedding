...
##### Load Data
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/Lorenz/delay_predicted.txt',u_predicted)
    np.savetxt('Predicted_Data/Lorenz/delay_actual.txt',u_data[S:])
...
plt.savefig('Img/Lorenz-Coarse/RCN-Traj.png')
plt.show()
####
...
plt.savefig('Img/Lorenz-Coarse/RCN-Recur.png')
plt.show()
####
plt.rcParams['figure.figsize'] = [16,8]
spec = gridspec.GridSpec( nrows=1,ncols=2,
...
plt.savefig('Img/Lorenz-Coarse/RCN-Attractor.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/RCN-Attractor-Overlay.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/RCN-Hist.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/RCN-Autocor.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/RCN-Autocor-Overlay.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/RCN-CDF.png')
plt.show()