...
##### Load Data
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/Henon/henon_predicted.txt',x_test_sim)
    np.savetxt('Predicted_Data/Henon/henon_actual.txt',u_data[S:])
...
plt.savefig('Img/Henon/Sindy-Traj.png')
plt.show()
# 
...
plt.savefig('Img/Henon/Sindy-Attractor-Overlay.png')
plt.show()
...
plt.savefig('Img/Henon/Sindy-Attractor.png')
plt.show()
...
plt.savefig('Img/Henon/Sindy-Hist.png')
plt.show()
...
plt.savefig('Img/Henon/Sindy-Autocor.png')
plt.show()
...
plt.savefig('Img/Henon/Sindy-Autocor-Overlay.png')
plt.show()
...
plt.savefig('Img/Henon/Sindy-CDF.png')
plt.show()