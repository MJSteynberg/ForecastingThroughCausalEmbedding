...
##### Load Data
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/Lorenz/sindy_predicted.txt',x_test_sim)
    np.savetxt('Predicted_Data/Lorenz/sindy_actual.txt',u_data[S:])
...
plt.savefig('Img/Lorenz-Coarse/Sindy-Traj.png')
plt.show()
####
...
plt.savefig('Img/Lorenz-Coarse/Sindy-Recur.png')
plt.show()
####
plt.rcParams['figure.figsize'] = [16,8]
spec = gridspec.GridSpec( nrows=1,ncols=2,
...
plt.savefig('Img/Lorenz-Coarse/Sindy-Attractor.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/Sindy-Attractor-Overlay.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/Sindy-Hist.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/Sindy-Autocor.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/Sindy-Autocor-Overlay.png')
plt.show()
...
plt.savefig('Img/Lorenz-Coarse/Sindy-CDF.png')
plt.show()