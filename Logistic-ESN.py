...
##### Load Data
    ...
    Y_train[:,0]=u_data[discard+1:discard+train_len+1, 0]
   ...
   #############################################
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/Logistic/esn_delay_predicted.txt',u_predicted)
    np.savetxt('Predicted_Data/Logistic/esn_delay_actual.txt',data[train_len+discard:train_len+discard+prediction_len])
...
try:
    ...
    axs1.plot(range(1000),u_predicted[0:1000],lw=0.5,color='darkblue')
    axs2.plot(range(1000),[x+1 for x in u_predicted[0:1000]],lw=0.5,color='darkblue')
    ...
    axs1.set(ylim = (-0.1, 0.22))
    axs2.set(yscale = 'log', ylim = (0.7, 100000))
    plt.savefig('Img/Logistic/ESN-Traj.png')
    plt.show()
    ...
    plt.savefig('Img/Logistic/ESN-Attractor.png')
    plt.show()
    ...
    plt.savefig('Img/Logistic/ESN-Attractor-Overlay.png')
    plt.show()
    ...
    plt.savefig('Img/Logistic/ESN-Hist.png')
    plt.show()
    ...
    plt.savefig('Img/Logistic/ESN-Autocor.png')
    plt.show()
    ...
    plt.savefig('Img/Logistic/ESN-Autocor-Overlay.png')
    plt.show()
    ...
    plt.savefig('Img/Logistic/ESN-CDF.png')
    plt.show()
except:
