...
##### Load Data
   ...
   #############################################
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/Henon_Fine/esn_delay_comp_predicted.txt',u_predicted)
    np.savetxt('Predicted_Data/Henon_Fine/esn_delay_comp_actual.txt',data[train_len+discard:train_len+discard+prediction_len])
...
try:
    ...
    axs1.plot(range(100),u_predicted[0:100,0],lw=0.5,color='darkblue')
    axs2.plot(range(100),[x + 1 for x in u_predicted[0:100,0]],lw=0.5,color='darkblue')
    ...
    axs1.set(ylim = (-0.2, 0.2))


    plt.savefig('Img/Henon_Fine/ESN-Traj.png')
    plt.show()
    # 
    ...
    plt.savefig('Img/Henon_Fine/ESN-Attractor-Overlay.png')
    plt.show()
    ...
    plt.savefig('Img/Henon_Fine/ESN-Attractor.png')
    plt.show()
    ...
    plt.savefig('Img/Henon_Fine/ESN-Hist.png')
    plt.show()
    ...
    plt.savefig('Img/Henon_Fine/ESN-Autocor.png')
    plt.show()
    ...
    plt.savefig('Img/Henon_Fine/ESN-Autocor-Overlay.png')
    plt.show()
    ...
    plt.savefig('Img/Henon_Fine/ESN-CDF.png')
    plt.show()
except:
