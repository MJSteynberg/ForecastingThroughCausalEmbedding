...
##### Load Data
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/DP/sindy_predicted.txt',x_test_sim)
    np.savetxt('Predicted_Data/DP/sindy_actual.txt',u_data[S:])
...
plt.savefig('Img/DP/Sindy-Traj.png')
plt.show()
### Recur
...
plt.savefig('Img/DP/Sindy-Recur.png')
plt.show()
####
#### Recur Overlay
...
plt.savefig('Img/DP/Sindy-Recur-Overlay_8.png')
plt.show()
####
#### Recur Overlay
plt.rcParams['figure.figsize'] = [5,5]
...
plt.savefig('Img/DP/Sindy-Recur-Overlay_16.png')
plt.show()
####
plt.rcParams['figure.figsize'] = [8,4]
spec = gridspec.GridSpec( nrows=1,ncols=2,
...
plt.savefig('Img/DP/Sindy-Attractor.png')
plt.show()
...
plt.savefig('Img/DP/Sindy-Attractor-Overlay.png')
plt.show()
...
plt.savefig('Img/DP/Sindy-Attractor-Overlay-Labels.png')
plt.show()
...
plt.savefig('Img/DP/Sindy-Hist.png')
plt.show()
## Autocorrelation
...
plt.savefig('Img/DP/Sindy-Autocor.png')
plt.show()
...
plt.savefig('Img/DP/Sindy-Autocor-Overlay.png')
plt.show()
...
plt.savefig('Img/DP/Sindy-CDF.png')
plt.show()