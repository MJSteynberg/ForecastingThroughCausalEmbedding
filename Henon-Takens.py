...
##### Load Data
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/Henon/takens_delay_comp_predicted.txt',u_predicted)
    np.savetxt('Predicted_Data/Henon/takens_delay_comp_actual.txt',data[train_len+discard:train_len+discard+prediction_len])
...
plt.savefig('Img/Henon/Takens-Traj.png')
plt.show()
# 
...
plt.savefig('Img/Henon/Takens-Attractor-Overlay.png')
plt.show()
...
plt.savefig('Img/Henon/Takens-Attractor.png')
plt.show()
...
plt.savefig('Img/Henon/Takens-Hist.png')
plt.show()
...
plt.savefig('Img/Henon/Takens-Autocor.png')
plt.show()
...
plt.savefig('Img/Henon/Takens-Autocor-Overlay.png')
plt.show()
...
plt.savefig('Img/Henon/Takens-CDF.png')
plt.show()