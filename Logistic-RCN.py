...
##### Load Data
    ...
    ax.plot(data[0:1000,0],data[1:1000+1,0], data[2:1000+2,0],lw=0.5,color='red')
    ...
    # Saving Data
    #############################################
    np.savetxt('Predicted_Data/Logistic/delay_predicted.txt',u_predicted)
    np.savetxt('Predicted_Data/Logistic/delay_actual.txt',u_data[S:])
...
plt.savefig('Img/Logistic/RCN-Traj.png')
plt.show()
...
plt.savefig('Img/Logistic/RCN-Attractor.png')
plt.show()
...
plt.savefig('Img/Logistic/RCN-Attractor-Overlay.png')
plt.show()
...
plt.savefig('Img/Logistic/RCN-Hist.png')
plt.show()
...
plt.savefig('Img/Logistic/RCN-Autocor.png')
plt.show()
...
plt.savefig('Img/Logistic/RCN-Autocor-Overlay.png')
plt.show()
...
plt.savefig('Img/Logistic/RCN-CDF.png')
plt.show()